...
class sewa():
    ...
    def set_data_sewa(self):
        ...
        self.id_mobil = int(input('masukkan id mobil yang disewa: '))
        self.lama_sewa = int(input('berapa lama anda menyewa mobil: '))
        self.query = 'INSERT INTO sewa (id_penyewa, id_mobil, lama_sewa) VALUES (?, ?, ?)'
        self.cursor.execute(self.query, [self.__id_penyewa, self.id_mobil, self.lama_sewa])
        self.con.commit()
